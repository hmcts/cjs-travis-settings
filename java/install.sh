...
$MVN -X -B -V -Dsilent=true -DskipTests=true -DskipITs=true -Dmaven.javadoc.skip=true package org.apache.maven.plugins:maven-dependency-plugin:3.1.1:go-offline "$@"
