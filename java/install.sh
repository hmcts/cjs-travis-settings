...
$MVN -B -V -Dsilent=true -DskipTests=true -DskipITs=true -Dmaven.repo.local=~/.m2/repository -Dmaven.javadoc.skip=true package org.apache.maven.plugins:maven-dependency-plugin:3.1.1:go-offline "$@"
